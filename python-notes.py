# Started based on Ken Jee's starter document @github.com/PlayingNumbers/data_science_starter
# Use this to collect useful commands
...
# Reshapes into the form of shape = array.shape
np.reshape()
